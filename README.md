...
<br>
<br>
  <a href="https://github.io/ssharp/cs465-fullstack" title="Full-Stack Web App">Traveler Getaway's Course Project</a>
<br>
</details>
...
<br>
<br>
  <a href="https://screenrec.com/share/Sgrxc0HTX6" title="Full Code Review">Code Review for Full Project</a>
<br>
</details>
...
<br>
<br>
  <a href="https://github.io/ssharp/cs465-fullstack/tree/milestone2" title="Full-Stack Web App - Updated">Traveler Getaway's   Enhancement One</a>
<br>
</details>
...
<br>
The course outcomes I planned to meet with this enhancement included creating an additional customer page for sending contact messages to the database, as well as a new SPA page for retrieval and viewing of these messages in a searchable table. This outcome has been met with an additional improvement by setting the landing page of the SPA admin web application to be the login page, so that only authorized users can access the trip and contact listing pages. This was done exclusively with software security in mind, as having an administrative webpage open to the public can introduce various insecurities into the software that can be mitigated with a simple landing page change. My outcome-coverage plan can be updated to reflect the completion of enhancement two.<br>
<br>
<br>
In carrying out the intended enhancements and modifications, I learned that form validation can be carried out within the model file itself to define form submission parameters on the data being sent to the database. I also learned to use images as visual cues in my contact error and success pages, as I modified these pages to have iconography aligning with the respective message to the user of a successful or faulty submission. One significant challenge I faced with this was getting the form validation to behave as intended. A pain point was actually forcing all user submitted contact tags to be capitalized in the input field, as well as for the form field. This required me to research the correct method for attempting autocapitalization, which led me to the answer that I was using a deprecated method that was no longer supported. Along with this, I had two separate methods utilized in different files, so I removed the redundant line of code after making the proper correction. 
<br>
</details>
...
<br>
<a href="https://www.flaticon.com/free-icons/graduation-cap" title="graduation cap icons">Graduation cap icons created by Magnific - Flaticon</a>
<br>
</details>
